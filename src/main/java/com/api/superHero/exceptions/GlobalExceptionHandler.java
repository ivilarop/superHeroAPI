...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> superHeroNotFoundException(SuperHeroNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorMessage> superHeroAlreadyExistException(SuperHeroAlreadyExistException ex, WebRequest request) {
        ErrorMessage message = new ErrorMessage(
